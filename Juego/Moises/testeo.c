...
int main () {
    ...
    printf(" --------------------------------------------------------------------------------------\n");
    printf("|     ___                  ____    _____       ____      ___      _____       ____     |\n");
    printf("|    /   \\   |       |   /    \\ |     \\    /    \\   /   \\   |     \\    /    \\   |\n");
    printf("|   /     \\  |       |  /      \\|      \\  /         /     \\  |      \\  /      \\  |\n");
    printf("|  /       \\ |       | |       | |       \\ |        /       \\ |       \\|        |  |\n");
    printf("| /_________\\|       | |       | |______ /  |       /_________\\|       | |        |  |\n");
    printf("| |         | |-------| |       | |      \\  |       |         | |       | |        |  |\n");
    printf("| |         | |       | |       | |       \\ |       |         | |       | |        |  |\n");
    printf("| |         | |       | |       | |        \\|       |         | |       / |        |  |\n");
    printf("| |         | |       |  \\     / |        | \\      |         | |      /   \\     /   |\n");
    ...
    {
    case 1:
        printf("Ingrese un numero para la tematica: 1.Marca 2.Objetos 3.Paises");
        scanf("%d",&tematica);
        
        switch (tematica)
        {
        case 1:
                File *archivo1 = fopen("marcafacil.txt", "r");
                if (archivo1 == NULL) {
        ...
        while (fgets(palabras1[contador1], sizeof(palabras1[contador1]), archivo2) != NULL) {
        ...
        case 2:
                File *archivo2 = fopen("objetosfacil.txt", "r");
                if (archivo2 == NULL) {
                    printf ("No se pudo abrir el archivo\n");
                return 1;
                }
        ...
        case 3:
                File *archivo3 = fopen("paisesfacil.txt", "r");
                if (archivo3 == NULL) {
                    printf ("No se pudo abrir el archivo\n");
                return 1;
                }
